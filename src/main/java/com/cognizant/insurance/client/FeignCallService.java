 ...
 * client code
 * 
 * This Feign Client is used by "iptms-insurance-microservice" to communicate
 * with "iptms-treatments-microservice"
 * 
 */

@FeignClient(name = "iptms-treaments-microservice", url = "http://iptmstreatment-env.eba-uwu8wr9i.us-east-2.elasticbeanstalk.com/iptms")
